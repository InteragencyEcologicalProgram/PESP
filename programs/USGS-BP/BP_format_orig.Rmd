...
```{r}
df_data_one <- add_meta_col(df_data_one, 'SF Bay Water Quality Program', 'Lab')

df_data_one <- add_meta_col(df_data_one, 'SF Bay Water Quality Program', 'SampleMethod')
```
...
write_log_file(standardized_unknowns, 'Groups/USGS_BP/02 Processed Data/QC files/tables/BP_Dufford_standardized_unknowns.csv')
...
## Add QC and Debris columns
```{r}
df_data_one <- df_data_one %>%
  mutate(QualityCheck = 'LackInfo',
         Debris = 'LackInfo')
```
...
## Add metadata columns
```{r}
df_data_two <- add_meta_col(df_data_two, 'SF Bay Water Quality Program', 'Lab')

df_data_two <- add_meta_col(df_data_two, 'SF Bay Water Quality Program', 'SampleMethod')
```
...
write_log_file(standardized_unknowns, 'Groups/USGS_BP/02 Processed Data/QC files/tables/BP_BSA_standardized_unknowns.csv')
...
TODO: FIX SAMPLE METHOD (DONT DO THIS WAY)

## Add metadata columns
```{r}
df_data_three <- add_meta_col(df_data_three, 'SF Bay Water Quality Program', 'Lab')

df_data_three <- add_meta_col(df_data_three, 'SF Bay Water Quality Program', 'SampleMethod')
```
...
write_log_file(standardized_unknowns, 'Groups/USGS_BP/02 Processed Data/QC files/tables/BP_Tow_standardized_unknowns.csv')
...
TODO: add multiple sizes QC for ones without Notes column
