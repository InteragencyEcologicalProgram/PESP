...
write_log_file(multi_ids, 'Groups/USBR-DOP/02 Processed Data/QC files/tables/DOP_multiple_ids.csv')
...
# write_log_file(nondistinct_rows, 'Groups/USBR-DOP/02 Processed Data/QC files/tables/DOP_nondistinct_rows.csv')
...
write_log_file(corrected_typos, 'Groups/USBR-DOP/02 Processed Data/QC files/tables/DOP_corrected_typos.csv')
...
```{r}
df_data <- clean_unknowns(df_data, std_sp = TRUE)
standardized_unknowns <- attr(df_data, 'log')$clean_unknowns
write_log_file(standardized_unknowns, 'Groups/USBR-DOP/02 Processed Data/QC files/tables/DOP_standardized_unknowns.csv')
...
write_log_file(updated_synonyms, 'Groups/USBR-DOP/02 Processed Data/QC files/tables/DOP_updated_synonyms.csv')
...
write_log_file(needs_hierarchy, 'Groups/USBR-DOP/02 Processed Data/QC files/tables/DOP_needs_hierarchy.csv')
...
write_log_file(combined_taxa, 'Groups/USBR-DOP/02 Processed Data/QC files/tables/DOP_combined_taxa.csv')
...
write_log_file(missing_latlon, 'Groups/USBR-DOP/02 Processed Data/QC files/tables/DOP_missing_latlon.csv')
...
write_log_file(missing_time, 'Groups/USBR-DOP/02 Processed Data/QC files/tables/DOP_missing_times.csv')
...
# Export
```{r}
write_csv(df_data, abs_pesp_path('Groups/USBR-DOP/02 Processed Data/DOP_draft.csv'))
```
