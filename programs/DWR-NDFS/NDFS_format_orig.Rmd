...
## Add in lab
```{r}
df_data_one <- add_meta_col(df_data_one, 'North Delta Food Subsidy Study', 'Lab')
...
## Add in lab
```{r}
df_data_two <- add_meta_col(df_data_two, 'North Delta Food Subsidy Study', 'Lab')
...
## Add in lab
```{r}
df_data_three <- add_meta_col(df_data_three, 'North Delta Food Subsidy Study', 'Lab')
...
## Add in lab
```{r}
df_data_four <- add_meta_col(df_data_four, 'North Delta Food Subsidy Study', 'Lab')
...
## Add in lab
```{r}
df_data_five <- add_meta_col(df_data_five, 'North Delta Food Subsidy Study', 'Lab')
unique_check(df_data_five, 'Lab')
```
...
write_log_file(corrected_typos, 'Groups/DWR-NDFS/02 Processed Data/QC files/tables/NDFS_corrected_typos.csv')
...
write_log_file(unmatched_comments, 'Groups/DWR-NDFS/02 Processed Data/QC files/tables/NDFS_leftover_comments.csv')
...
write_log_file(standardized_unknowns, 'Groups/DWR-NDFS/02 Processed Data/QC files/tables/NDFS_standardized_unknowns.csv')
...
write_log_file(updated_synonyms, 'Groups/DWR-NDFS/02 Processed Data/QC files/tables/NDFS_updated_synonyms.csv')
...
write_log_file(needs_hierarchy, 'Groups/DWR-NDFS/02 Processed Data/QC files/tables/NDFS_needs_hierarchy.csv')
...
write_log_file(combined_taxa, 'Groups/DWR-NDFS/02 Processed Data/QC files/tables/NDFS_combined_taxa.csv')
...
## Add sample method
```{r}
df_data <- add_meta_col(df_data, 'North Delta Food Subsidy Study', 'SampleMethod')
```
...
```{r}
write_csv(df_data, abs_pesp_path('Groups/DWR-NDFS/02 Processed Data/NDFS_draft.csv'))
```
