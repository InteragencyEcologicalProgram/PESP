...
write_log_file(taxon_notes, 'Synthesized Dataset/01 Group Checks/CDFW-FRP/tables/FRP_taxon_notes.csv')
print(taxon_notes)

unmatched_notes <- attr(df_frp, 'log')$unmatched_notes
write_log_file(unmatched_notes, 'Synthesized Dataset/01 Group Checks/CDFW-FRP/tables/FRP_unmatched_taxon_notes.csv')
...
write_log_file(unmatched_comments, 'Synthesized Dataset/01 Group Checks/CDFW-FRP/tables/FRP_leftover_comments.csv')
