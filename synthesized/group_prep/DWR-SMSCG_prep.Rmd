...
data_path_smscg <- abs_pesp_path('Groups/DWR-SMSCG/02 Processed Data/smscg_phytoplankton_samples_2020-2023.csv')
...
```{r}
df_smscg <- clean_unknowns(df_smscg, std_sp = TRUE)
...
```{r}
save(df_smscg, file = 'synthesized/group_prep/group_data/DWR-SMSCG.Rdata')
```
