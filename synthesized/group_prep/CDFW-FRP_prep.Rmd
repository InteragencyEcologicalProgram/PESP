...
write_log_file(taxon_notes, 'Groups/CDFW-FRP/02 Processed Data/QC files/tables/FRP_taxon_notes.csv')
print(taxon_notes)

unmatched_notes <- attr(df_frp, 'log')$unmatched_notes
write_log_file(unmatched_notes, 'Groups/CDFW-FRP/02 Processed Data/QC files/tables/FRP_unmatched_taxon_notes.csv')
...
write_log_file(unmatched_comments, 'Groups/CDFW-FRP/02 Processed Data/QC files/tables/FRP_leftover_comments.csv')
