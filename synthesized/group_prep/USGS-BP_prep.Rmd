...
# Magnification
df_bp <- add_meta_col(df_bp, 'USGS-BP', 'Magnification', match_cols = 'SampleMethod') # FIX HOW THIS WORKS
...
# Count Method
df_bp <- add_meta_col(df_bp, 'USGS-BP', 'CountMethodSample')
