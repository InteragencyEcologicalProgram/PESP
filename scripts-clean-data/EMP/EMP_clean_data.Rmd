...
```{r}
# read in data
df_syn <- read_csv('data/phyto_classification.csv', show_col_types = FALSE)
df_data <- read_csv('data/EMP/Phyto Data 2008-present_012723.csv', show_col_types = FALSE)
...
## Export
```{r}
write_csv(df_joined,'data/cleaned/EMP_Phyto_Data_2008-2021.csv')
```
